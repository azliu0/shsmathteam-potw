...
% If $AB$ be the diameter of a semicircle, and $TP$, $TQ$ the tangents to it from any point $T$, and if $AQ$, $BP$ be joined meeting in $R$, then $TR$ is perpendicular to $AB$.\V
