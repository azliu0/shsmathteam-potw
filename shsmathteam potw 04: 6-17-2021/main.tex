...
\fancypagestyle{regular}{
  \lhead{PoTW 4: Week of 6-17-2021}
  \rhead{SHS Math Team}
  \cfoot{\thepage}
...
\textbf{PoTW 4: Week of 6-17-2021}}}
...
Let square $RUDA$ have center $P$, and $XY$ be a segment passing through $P$ such that $X$ lies on $RU$ and $Y$ lies on $DA$. Identify the shape of the locus of all possible centroids of trapezoid $UDYX$.\V

\textit{helpful hint: Try finding an analogy between this problem and an equivalent physical system, and then use concepts from physics-mechanics to solve this question.}
